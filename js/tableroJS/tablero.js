...
const ponerCirculo = a =>
  a.insertAdjacentHTML("afterbegin", '<i class="circulo"></i>');
const ponerEquis = a =>
  a.insertAdjacentHTML("afterbegin", '<i class="equis"></i>');
...
class Juego {
  ...
  reset() {
    ...
    if (this.partidas % 2 == 1) {
      ...
      document
        .getElementById(posicionAleatoriaInicial)
